...
public class MaximumThirdPosition<T>
{
	T num1,num2,num3;

	public MaximumThirdPosition(T num1,T num2,T num3)
	{
		this.num1 = num1;
		this.num2 = num2;
		this.num3 = num3;
	...
	{ 
		System.out.println("The Maximum Among 3 Integer : "+maxAmong3Number(30,20,40));  
